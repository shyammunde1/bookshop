              ...
              <div className="flex items-center my-1">
                <input
                  onChange={() =>
                    dispatch({
                      type: "RATING",
                      payload: { ratings: "4Star_Above" },
                    })
                  }
                  checked={state.ratings === "4Star_Above" || false}
                  id="rating-sort-1"
                  type="radio"
                  value=""
                  name="rating-sort"
              ...
              <div className="flex items-center my-1">
                <input
                  onChange={() =>
                    dispatch({
                      type: "RATING",
                      payload: { ratings: "3Star_Above" },
                    })
                  }
                  checked={state.ratings === "3Star_Above" || false}
                  id="rating-sort-2"
                  type="radio"
                  value=""
                  name="rating-sort"
              ...
              <div className="flex items-center my-1">
                <input
                  onChange={() =>
                    dispatch({
                      type: "RATING",
                      payload: { ratings: "2Star_Above" },
                    })
                  }
                  checked={state.ratings === "2Star_Above" || false}
                  id="rating-sort-3"
                  type="radio"
                  value=""
                  name="rating-sort"
              ...
              <div className="flex items-center my-1">
                <input
                  onChange={() =>
                    dispatch({
                      type: "RATING",
                      payload: { ratings: "1Star_Above" },
                    })
                  }
                  checked={state.ratings === "1Star_Above" || false}
                  id="rating-sort-4"
                  type="radio"
                  value=""
                  name="rating-sort"
